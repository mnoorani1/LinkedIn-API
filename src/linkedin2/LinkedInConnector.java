...
// there is no body just a header
    ...
    {
        String url="http://api.linkedin.com/v1/people/~/network/updates?scope=self&count=1&oauth2_access_token="+access_token;
        //String url="http://api.linkedin.com/v1/people/~/network/network-stats";
        OAuthRequest oAuthRequest = new OAuthRequest(Verb.GET, url);

        //Preparing XML payload to Share Content via LinkedIn
        service.signRequest(accessToken, oAuthRequest);
        Response responsee = oAuthRequest.send();
